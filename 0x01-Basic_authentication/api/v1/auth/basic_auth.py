...
class BasicAuth(Auth):
    """basic authentication classs"""
    def extract_base64_authorization_header(self,
                                            authorization_header: str) -> str:
        """Base64 part of the Authorization header
           for a Basic Authentication
           Args:
             authorization_header: part authorization in header
           Return:
             Base64 ârt of header authentication
        """
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        ...
        if Autheader is not None:
            token = self.extract_base64_authorization_header(Autheader)
